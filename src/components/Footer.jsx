...
import { BUSINESS_INFO, SOCIAL_LINKS, NAVIGATION } from '../utils/constants'
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-serif font-bold text-gold">Anuus Beauty</h3>
            <p className="text-gray-300 leading-relaxed">
              Luxury beauty parlor and boutique offering premium services and custom fashion design.
            </p>
            ...
            <ul className="space-y-2">
              {NAVIGATION.map((item) => (
                <li key={item.path}>
                  <Link 
                    to={item.path} 
                    className="text-gray-300 hover:text-gold transition-colors duration-200 block py-1"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <address className="text-gray-300 not-italic space-y-2">
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
